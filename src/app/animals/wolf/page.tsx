          ...
          <div className="grid lg:grid-cols-[1fr_300px] gap-10 mt-2">
            <article className="prose-content min-w-0">
              <h1 className="text-3xl sm:text-4xl font-bold text-[#17211B] mb-2 leading-tight">
                Wolf <ScientificName scientificName="Canis lupus" />
              </h1>
              <p className="mb-8">
              ...
              {WOLF_IMAGE && <AnimalHeroImage image={WOLF_IMAGE} priority />}
              ...
              <div className="mt-10">
                <AnimalComparisonLinks slug="wolf" />
              </div>
