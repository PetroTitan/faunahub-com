...
const birds = [
  ...
  { href: "/animals/rook", label: "Rook", desc: "Corvus frugilegus — a colonial farmland corvid; the bare pale face separates adults from crows." },
  ...
  { href: "/animals/osprey", label: "Osprey", desc: "Pandion haliaetus — a fish specialist in its own family, Pandionidae; not an eagle." },
