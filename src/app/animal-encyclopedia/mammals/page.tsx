...
const mammals = [
  ...
  { href: "/animals/mule", label: "Mule", desc: "Equus asinus × Equus caballus — the donkey-horse hybrid; not a species." },
  ...
  { href: "/animals/rat", label: "Rat", desc: "Genus Rattus — the brown and black rat, and the wild species behind the name." },
