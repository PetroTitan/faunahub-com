...
export const metadata: Metadata = buildMetadata({
  title: "Hamster Care Guides — Planning & Resources",
  description:
    "Practical resources for prospective and current hamster owners — cost framework, age tools, and vet-care planning. Educational only; consult a small-mammal-savvy veterinarian for clinical decisions.",
  path: "/small-pets/hamsters",
});

export default function HamstersHubPage() {
  const breadcrumb = breadcrumbSchema([
    { name: "Home", url: "https://faunahub.com" },
    { name: "Small Pets", url: "https://faunahub.com/small-pets" },
    { name: "Hamsters", url: "https://faunahub.com/small-pets/hamsters" },
  ]);
    ...
    <>
      ...
      <main id="main-content">
        <header className="bg-white border-b border-[#DDE6DD] py-10 sm:py-14">
          <div className="container-content">
            ...
            <p className="text-base text-[#2C3A2F] leading-relaxed max-w-2xl">
              Hamsters have a low purchase cost but real welfare needs:
              substantially larger enclosures than typical pet-store cages, a
              proper running wheel, deep substrate, and species-savvy
              veterinary care. Lifespan is typically only one to three years.
              The resources below pair with broader small-pet and vet-care
              guides on FaunaHub.
            </p>
          </div>
        </header>
        ...
        <div className="container-content py-10 space-y-10">
          <RelatedLinks
            title="Hamster planning and care resources"
            links={[
              {
                label: "How much does a hamster cost?",
                href: "/small-pets/hamsters/how-much-does-a-hamster-cost",
                description: "Setup, recurring, and welfare-cost framework",
              },
              {
              ...
              },
              {
                ...
                description: "Honest pet-choice guide including hamsters",
              },
              {
          ...
          <p className="text-sm text-[#5E6B63]">
            Detailed hamster care and housing guides are in development. For
