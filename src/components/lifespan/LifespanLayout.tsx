...
/**
 * Shared, accessible layout for the Animal Lifespans & Life Stages cluster.
 * Centralises the header, a standing educational + lifespan-variation +
 * veterinary-boundary note on every page, schema (BreadcrumbList + FAQPage
 * where a real FAQ exists), and related links. The note is boundary language,
 * never an excuse for medical advice or a lifespan prediction.
 */
        ...
        <div className="container-content py-12">
          ...
          >
            <h2 className="text-sm font-semibold text-[#063F2A] uppercase tracking-wider mb-2">
              Educational only — lifespans vary
            </h2>
            <p className="text-sm sm:text-base text-[#2C3A2F] leading-relaxed">
              This is general educational information about animal lifespans and life stages. Lifespan
              varies by species, genetics, environment, sex, body size, predation, disease, and — for
              animals in human care — the care they receive, so any figures here are broad,
              source-cautious examples rather than guarantees. This page is not veterinary advice and
              not a lifespan prediction for any individual animal; it gives no diagnosis, treatment,
              dosage, or emergency guidance. For an animal&apos;s health, consult a qualified
              veterinarian.
            </p>
          </aside>
...
/** Text-labelled lifespan-context badge (no colour-only meaning). */
