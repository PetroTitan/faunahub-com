...
import {
  ...
  type SmallPetArticle,
  type SmallPetSection,
...
export default function SmallPetArticleView({
  article,
}: {
  article: SmallPetArticle;
}) {
  const url = `${SITE}${article.path}`;

  const breadcrumbItems = [
    { label: "Small Pets", href: "/small-pets" },
    { label: "Care", href: "/small-pets/care" },
          ...
          <div className="grid lg:grid-cols-[1fr_300px] gap-10 mt-2">
            <article className="prose-content min-w-0">
              <p className="mb-3 not-prose">
                ...
                <span className="tag ml-1">Small pet care</span>
              </p>
            ...
            >
              ...
              >
                ...
                <p className="leading-relaxed">{SMALL_PET_SOURCE_NOTE}</p>
              </aside>
