...
export const ANIMAL_TAXONOMY_GROUPS: readonly AnimalTaxonomyGroup[] = [
  ...
  g({ slug: "mollusks", label: "Mollusks", parentSlug: "invertebrates", rankLabel: "phylum", description: "A huge phylum including snails, clams, octopuses, and squid.", coverageStatus: "thin", existingAnimalSlugs: ["octopus","squid","giant-squid","dumbo-octopus"], priorityMissingExamples: ["snail","slug","clam","oyster","mussel","scallop","nautilus","cuttlefish","nudibranch","cone-snail"], futureBatchPriority: "high", sources: MARINE }),
