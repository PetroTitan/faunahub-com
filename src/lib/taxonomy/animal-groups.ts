...
export const ANIMAL_TAXONOMY_GROUPS: readonly AnimalTaxonomyGroup[] = [
  ...
  g({ slug: "fish", label: "Fish", parentSlug: "vertebrates", rankLabel: "informal-group", description: "Aquatic vertebrates spanning sharks and rays, bony fish, and more — an informal grouping rather than a single lineage.", coverageStatus: "strong", existingAnimalSlugs: ["shark","ray","eel","tuna","salmon","seahorse","clownfish","pufferfish","betta-fish","goldfish","guppy","angelfish","tetra","koi","carp","catfish","great-white-shark","hammerhead-shark","barracuda","grouper","moray-eel","lionfish","anglerfish","frilled-shark","coelacanth","cod","mackerel","piranha","parrotfish","seadragon","mudskipper"], priorityMissingExamples: ["herring","swordfish","marlin","lanternfish","anchovy","sardine"], futureBatchPriority: "medium", sources: [...CORE, SRC_WORMS], notes: "“Fish” is not a single evolutionary group; it spans several lineages." }),

  // ===========================================================================
  // INVERTEBRATE GROUPS
  // ===========================================================================
  g({ slug: "insects", label: "Insects", parentSlug: "invertebrates", rankLabel: "class", description: "Six-legged arthropods — the most diverse group of animals by described species.", coverageStatus: "partial", existingAnimalSlugs: ["bee","butterfly","ant","dragonfly","ladybug","praying-mantis","beetle","moth","grasshopper"], priorityMissingExamples: ["cricket","wasp","termite","firefly","cicada","cockroach","aphid"], futureBatchPriority: "high", sources: CORE, notes: "Insects are widely regarded as the most species-rich animal group, though exact totals vary by source." }),
  g({ slug: "arachnids", label: "Arachnids", parentSlug: "invertebrates", rankLabel: "class", description: "Eight-legged arthropods — spiders, scorpions, ticks, and mites.", coverageStatus: "partial", existingAnimalSlugs: ["spider","scorpion","tarantula"], priorityMissingExamples: ["tick","mite","harvestman","whip-scorpion","jumping-spider"], futureBatchPriority: "high", sources: CORE }),
  g({ slug: "crustaceans", label: "Crustaceans", parentSlug: "invertebrates", rankLabel: "informal-group", description: "Mostly aquatic arthropods — crabs, lobsters, shrimp, krill, and more.", coverageStatus: "partial", existingAnimalSlugs: ["crab","lobster","giant-isopod","shrimp","barnacle","krill"], priorityMissingExamples: ["crayfish","yeti-crab","mantis-shrimp","amphipod","fiddler-crab"], futureBatchPriority: "high", sources: MARINE }),
  g({ slug: "mollusks", label: "Mollusks", parentSlug: "invertebrates", rankLabel: "phylum", description: "A huge phylum including snails, clams, octopuses, and squid.", coverageStatus: "partial", existingAnimalSlugs: ["octopus","squid","giant-squid","dumbo-octopus","nautilus","cuttlefish","nudibranch","snail","slug"], priorityMissingExamples: ["clam","oyster","mussel","scallop","cone-snail","abalone"], futureBatchPriority: "high", sources: MARINE }),
  g({ slug: "echinoderms", label: "Echinoderms", parentSlug: "invertebrates", rankLabel: "phylum", description: "Spiny-skinned marine animals — sea stars, urchins, sea cucumbers, and relatives.", coverageStatus: "partial", existingAnimalSlugs: ["starfish","sea-urchin"], priorityMissingExamples: ["sea-cucumber","sand-dollar","brittle-star","crinoid"], futureBatchPriority: "medium", sources: MARINE }),
  g({ slug: "cnidarians", label: "Cnidarians", parentSlug: "invertebrates", rankLabel: "phylum", description: "Stinging-celled animals — jellyfish, corals, sea anemones, and hydrozoans.", coverageStatus: "strong", existingAnimalSlugs: ["jellyfish","coral","brain-coral","staghorn-coral","elkhorn-coral","sea-fan","mushroom-coral","sea-anemone"], priorityMissingExamples: ["hydra","portuguese-man-o-war","box-jellyfish","sea-pen"], futureBatchPriority: "high", sources: MARINE }),
  g({ slug: "annelids", label: "Annelids", parentSlug: "invertebrates", rankLabel: "phylum", description: "Segmented worms — earthworms, leeches, and marine bristle worms.", coverageStatus: "thin", existingAnimalSlugs: ["earthworm"], priorityMissingExamples: ["leech","ragworm","tube-worm","lugworm"], futureBatchPriority: "medium", sources: CORE }),
  ...
  g({ slug: "other-invertebrates", label: "Other Invertebrates", parentSlug: "invertebrates", rankLabel: "informal-group", description: "Many further invertebrate groups exist, from tardigrades to comb jellies and velvet worms.", coverageStatus: "thin", existingAnimalSlugs: ["centipede","millipede"], priorityMissingExamples: ["tardigrade","comb-jelly","velvet-worm","horseshoe-crab","sea-squirt"], futureBatchPriority: "medium", sources: CORE }),

  // ===========================================================================
  // MARINE CROSS-CUTTING (topic groups)
  // ===========================================================================
  g({ slug: "reef-animals", label: "Reef Animals", rankLabel: "topic-group", description: "Animals associated with coral reefs — reef fish, corals, and invertebrates.", coverageStatus: "strong", existingAnimalSlugs: ["clownfish","pufferfish","seahorse","octopus","moray-eel","grouper","lionfish","coral","brain-coral","staghorn-coral","elkhorn-coral","sea-fan","mushroom-coral","sea-anemone","parrotfish"], priorityMissingExamples: ["reef-shark","wrasse","damselfish","butterflyfish"], futureBatchPriority: "medium", sources: MARINE }),
  g({ slug: "deep-sea-animals", label: "Deep-Sea Animals", rankLabel: "topic-group", description: "Animals of the ocean's dark, high-pressure depths. Described on FaunaHub's ocean depth pages, with a growing set of dedicated profiles.", coverageStatus: "partial", existingAnimalSlugs: ["giant-isopod","dumbo-octopus","coelacanth","giant-squid","anglerfish","frilled-shark"], priorityMissingExamples: ["vampire-squid","gulper-eel","barreleye","viperfish","fangtooth","yeti-crab"], futureBatchPriority: "high", sources: MARINE }),
  g({ slug: "open-ocean-animals", label: "Open-Ocean Animals", rankLabel: "topic-group", description: "Animals of the open water column — fast pelagic predators and ocean wanderers.", coverageStatus: "partial", existingAnimalSlugs: ["shark","tuna","whale","dolphin","sea-turtle","ray","orca","common-dolphin","pilot-whale","great-white-shark","barracuda"], priorityMissingExamples: ["marlin","swordfish","flying-fish","ocean-sunfish"], futureBatchPriority: "low", sources: MARINE }),
