...
export const ANIMAL_TAXONOMY_GROUPS: readonly AnimalTaxonomyGroup[] = [
  ...
  g({ slug: "fish", label: "Fish", parentSlug: "vertebrates", rankLabel: "informal-group", description: "Aquatic vertebrates spanning sharks and rays, bony fish, and more — an informal grouping rather than a single lineage.", coverageStatus: "strong", existingAnimalSlugs: ["shark","ray","eel","tuna","salmon","seahorse","clownfish","pufferfish","betta-fish","goldfish","guppy","angelfish","tetra","koi","carp","catfish","great-white-shark","hammerhead-shark","barracuda","grouper","moray-eel","lionfish"], priorityMissingExamples: ["cod","herring","swordfish","marlin","piranha","anglerfish"], futureBatchPriority: "medium", sources: [...CORE, SRC_WORMS], notes: "“Fish” is not a single evolutionary group; it spans several lineages." }),
