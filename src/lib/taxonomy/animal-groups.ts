...
export const ANIMAL_TAXONOMY_GROUPS: readonly AnimalTaxonomyGroup[] = [
  ...
  // VERTEBRATE CLASSES
  // ===========================================================================
  g({ slug: "mammals", label: "Mammals", parentSlug: "vertebrates", rankLabel: "class", description: "Warm-blooded vertebrates that feed young with milk — from big cats and primates to whales and bats.", coverageStatus: "strong", existingAnimalSlugs: ["lion","tiger","leopard","jaguar","cheetah","wolf","fox","bear","panda","red-panda","elephant","giraffe","zebra","gorilla","chimpanzee","lemur","kangaroo","koala","wombat","platypus","sloth","armadillo","porcupine","meerkat","tapir","hyena","deer","moose","lynx","badger","beaver","hedgehog","bat","raccoon","otter","seal","whale","dolphin","horse","cow","goat","sheep","pig","rabbit","guinea-pig","hamster"], priorityMissingExamples: ["hippopotamus","rhinoceros","orangutan","camel","bison","walrus","mongoose","weasel","squirrel","mole"], futureBatchPriority: "medium", sources: [...CORE, SRC_IUCN_HOME] }),
  g({ slug: "birds", label: "Birds", parentSlug: "vertebrates", rankLabel: "class", description: "Feathered, egg-laying vertebrates — raptors, waterbirds, songbirds, and more.", coverageStatus: "strong", existingAnimalSlugs: ["eagle","owl","penguin","parrot","falcon","hawk","vulture","duck","goose","swan","crow","raven","pigeon","sparrow","robin","flamingo","peacock","toucan","hummingbird","woodpecker","pelican","stork"], priorityMissingExamples: ["ostrich","emu","cassowary","kiwi","heron","kingfisher","albatross","seagull","magpie","cardinal"], futureBatchPriority: "medium", sources: CORE }),
  g({ slug: "reptiles", label: "Reptiles", parentSlug: "vertebrates", rankLabel: "class", description: "Scaled vertebrates including crocodilians, lizards, snakes, and turtles.", coverageStatus: "strong", existingAnimalSlugs: ["crocodile","alligator","caiman","snake","anaconda","turtle","sea-turtle","chameleon","iguana","gecko","komodo-dragon","monitor-lizard"], priorityMissingExamples: ["tortoise","cobra","python","rattlesnake","boa","skink","gila-monster","tuatara"], futureBatchPriority: "medium", sources: CORE, notes: "“Reptiles” as traditionally used is paraphyletic; modern classifications group birds with reptiles." }),
  g({ slug: "amphibians", label: "Amphibians", parentSlug: "vertebrates", rankLabel: "class", description: "Frogs, toads, salamanders, newts, and caecilians — many with life stages tied to water.", coverageStatus: "partial", existingAnimalSlugs: ["frog","toad","salamander","newt"], priorityMissingExamples: ["tree-frog","bullfrog","poison-dart-frog","fire-salamander","caecilian","hellbender"], futureBatchPriority: "high", sources: CORE }),
  ...
  g({ slug: "open-ocean-animals", label: "Open-Ocean Animals", rankLabel: "topic-group", description: "Animals of the open water column — fast pelagic predators and ocean wanderers.", coverageStatus: "partial", existingAnimalSlugs: ["shark","tuna","whale","dolphin","sea-turtle","ray"], priorityMissingExamples: ["marlin","swordfish","flying-fish","ocean-sunfish"], futureBatchPriority: "low", sources: MARINE }),
  ...
  g({ slug: "urban-wildlife", label: "Urban Wildlife", rankLabel: "topic-group", description: "Wild animals that thrive around people and cities.", coverageStatus: "partial", existingAnimalSlugs: ["raccoon","pigeon","fox","crow","sparrow"], priorityMissingExamples: ["rat","squirrel","seagull","opossum","starling"], futureBatchPriority: "low", sources: CORE }),
