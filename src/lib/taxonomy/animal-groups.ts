...
export const ANIMAL_TAXONOMY_GROUPS: readonly AnimalTaxonomyGroup[] = [
  ...
  g({ slug: "cnidarians", label: "Cnidarians", parentSlug: "invertebrates", rankLabel: "phylum", description: "Stinging-celled animals — jellyfish, corals, sea anemones, and hydrozoans.", coverageStatus: "partial", existingAnimalSlugs: ["jellyfish","coral"], priorityMissingExamples: ["sea-anemone","hydra","portuguese-man-o-war","sea-fan"], futureBatchPriority: "high", sources: MARINE }),
  ...
  // ===========================================================================
  g({ slug: "reef-animals", label: "Reef Animals", rankLabel: "topic-group", description: "Animals associated with coral reefs — reef fish, corals, and invertebrates.", coverageStatus: "partial", existingAnimalSlugs: ["clownfish","pufferfish","seahorse","octopus","moray-eel","grouper","lionfish","coral"], priorityMissingExamples: ["sea-anemone","parrotfish","reef-shark","wrasse"], futureBatchPriority: "medium", sources: MARINE }),
