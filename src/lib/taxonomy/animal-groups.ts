...
export const ANIMAL_TAXONOMY_GROUPS: readonly AnimalTaxonomyGroup[] = [
  ...
  g({ slug: "fish", label: "Fish", parentSlug: "vertebrates", rankLabel: "informal-group", description: "Aquatic vertebrates spanning sharks and rays, bony fish, and more — an informal grouping rather than a single lineage.", coverageStatus: "strong", existingAnimalSlugs: ["shark","ray","eel","tuna","salmon","seahorse","clownfish","pufferfish","betta-fish","goldfish","guppy","angelfish","tetra","koi","carp","catfish","great-white-shark","hammerhead-shark","barracuda","grouper","moray-eel","lionfish","anglerfish","frilled-shark","coelacanth"], priorityMissingExamples: ["cod","herring","swordfish","marlin","piranha","lanternfish"], futureBatchPriority: "medium", sources: [...CORE, SRC_WORMS], notes: "“Fish” is not a single evolutionary group; it spans several lineages." }),

  // ===========================================================================
  // INVERTEBRATE GROUPS
  // ===========================================================================
  g({ slug: "insects", label: "Insects", parentSlug: "invertebrates", rankLabel: "class", description: "Six-legged arthropods — the most diverse group of animals by described species.", coverageStatus: "partial", existingAnimalSlugs: ["bee","butterfly","ant","dragonfly","ladybug","praying-mantis","beetle"], priorityMissingExamples: ["grasshopper","cricket","moth","wasp","termite","firefly","cicada","cockroach","aphid"], futureBatchPriority: "high", sources: CORE, notes: "Insects are widely regarded as the most species-rich animal group, though exact totals vary by source." }),
  ...
  g({ slug: "crustaceans", label: "Crustaceans", parentSlug: "invertebrates", rankLabel: "informal-group", description: "Mostly aquatic arthropods — crabs, lobsters, shrimp, krill, and more.", coverageStatus: "partial", existingAnimalSlugs: ["crab","lobster","giant-isopod","shrimp","barnacle"], priorityMissingExamples: ["crayfish","krill","yeti-crab","mantis-shrimp","amphipod"], futureBatchPriority: "high", sources: MARINE }),
  g({ slug: "mollusks", label: "Mollusks", parentSlug: "invertebrates", rankLabel: "phylum", description: "A huge phylum including snails, clams, octopuses, and squid.", coverageStatus: "partial", existingAnimalSlugs: ["octopus","squid","giant-squid","dumbo-octopus","nautilus","cuttlefish","nudibranch"], priorityMissingExamples: ["snail","slug","clam","oyster","mussel","scallop","cone-snail","abalone"], futureBatchPriority: "high", sources: MARINE }),
  ...
  g({ slug: "other-invertebrates", label: "Other Invertebrates", parentSlug: "invertebrates", rankLabel: "informal-group", description: "Many further invertebrate groups exist, from tardigrades to comb jellies and velvet worms.", coverageStatus: "thin", existingAnimalSlugs: ["centipede"], priorityMissingExamples: ["millipede","tardigrade","comb-jelly","velvet-worm","horseshoe-crab","sea-squirt"], futureBatchPriority: "medium", sources: CORE }),

  // ===========================================================================
  // MARINE CROSS-CUTTING (topic groups)
  // ===========================================================================
  g({ slug: "reef-animals", label: "Reef Animals", rankLabel: "topic-group", description: "Animals associated with coral reefs — reef fish, corals, and invertebrates.", coverageStatus: "strong", existingAnimalSlugs: ["clownfish","pufferfish","seahorse","octopus","moray-eel","grouper","lionfish","coral","brain-coral","staghorn-coral","elkhorn-coral","sea-fan","mushroom-coral","sea-anemone"], priorityMissingExamples: ["parrotfish","reef-shark","wrasse","damselfish"], futureBatchPriority: "medium", sources: MARINE }),
