...
export const ANIMAL_TAXONOMY_GROUPS: readonly AnimalTaxonomyGroup[] = [
  ...
  g({ slug: "arachnids", label: "Arachnids", parentSlug: "invertebrates", rankLabel: "class", description: "Eight-legged arthropods — spiders, scorpions, ticks, and mites.", coverageStatus: "partial", existingAnimalSlugs: ["spider","scorpion"], priorityMissingExamples: ["tarantula","tick","mite","harvestman","whip-scorpion"], futureBatchPriority: "high", sources: CORE }),
  g({ slug: "crustaceans", label: "Crustaceans", parentSlug: "invertebrates", rankLabel: "informal-group", description: "Mostly aquatic arthropods — crabs, lobsters, shrimp, krill, and more.", coverageStatus: "thin", existingAnimalSlugs: ["crab","lobster","giant-isopod"], priorityMissingExamples: ["shrimp","crayfish","barnacle","krill","yeti-crab"], futureBatchPriority: "high", sources: MARINE }),
  g({ slug: "mollusks", label: "Mollusks", parentSlug: "invertebrates", rankLabel: "phylum", description: "A huge phylum including snails, clams, octopuses, and squid.", coverageStatus: "thin", existingAnimalSlugs: ["octopus","squid","giant-squid","dumbo-octopus","nautilus"], priorityMissingExamples: ["snail","slug","clam","oyster","mussel","scallop","cuttlefish","nudibranch","cone-snail"], futureBatchPriority: "high", sources: MARINE }),
