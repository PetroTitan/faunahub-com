...
export const ANIMAL_TAXONOMY_GROUPS: readonly AnimalTaxonomyGroup[] = [
  ...
  g({ slug: "urban-wildlife", label: "Urban Wildlife", rankLabel: "topic-group", description: "Wild animals that thrive around people and cities.", coverageStatus: "partial", existingAnimalSlugs: ["raccoon","pigeon","fox","crow","sparrow","squirrel"], priorityMissingExamples: ["rat","seagull","opossum","starling"], futureBatchPriority: "low", sources: CORE }),
