...
export const BATCH_B3_07 = [
  ...
  defineComparison({
    ...
    narrative: {
      ...
      sensesAdaptations:
        "The osprey carries a specialist toolkit for entering water: closable nostrils, dense oiled plumage, a reversible outer toe and rows of spicules under the toes that bite into a wet scaled body. The bald eagle keeps standard sea-eagle equipment — a long heavy bill for tearing, strong feet without spicules, and no adaptation for submerging. Both have the high visual acuity common to daytime hunters, and neither should be described as out-seeing the other.",
      lifespan:
